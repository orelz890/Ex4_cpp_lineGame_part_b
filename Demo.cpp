...
// 	std::cout << "Duke has " << duke.coins() << " coins\n";
// 	ambassador.transfer(duke, assassin); //transfers 1 coin from duke to assassin
// 	std::cout << "Assassin Yossi has " << assassin.coins() << " coins\n";
// 	std::cout << "Duke has " << duke.coins() << " coins\n";
// 	captain.foreign_aid();
...
// 	std::cout << "Contessa has " << contessa.coins() << " coins\n";
// 	std::cout << "Captain has " << captain.coins() << " coins\n";
